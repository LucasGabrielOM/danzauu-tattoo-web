          ...
          <div className="lg:col-span-7 space-y-5 text-left">
            ...
            <div className="pt-2 flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-2.5 px-6 py-3 rounded-full border border-emerald-500/40 bg-zinc-900 hover:bg-emerald-950/40 hover:border-emerald-400 text-zinc-100 hover:text-white text-xs font-bold shadow-md transition-all active:scale-95"
              >
