      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          <div className="inline-flex items-center gap-2 rounded-full border border-purple-200 bg-purple-50 px-3.5 py-1 mb-3 shadow-sm">
            <span className="text-xs font-bold uppercase tracking-widest text-purple-900 flex items-center gap-1.5">
        ...
        {/* Form Card */}
        <div className="rounded-3xl border border-purple-100 bg-white/95 p-6 sm:p-8 shadow-xl backdrop-blur-sm">
          <form onSubmit={handleSendWhatsApp} className="space-y-6">
                ...
                {placements.map((place) => (
                  <button
                    ...
                    className={`py-2.5 px-3 rounded-xl text-xs font-semibold transition-all text-center border ${
                      placement === place 
                        ? "bg-purple-700 border-purple-800 text-white font-bold shadow-sm" 
                        : "bg-purple-50/50 border-purple-100 text-zinc-700 hover:border-purple-300 hover:text-purple-900"
                    }`}
                  >
                    {place}
                  </button>
                  ...
                  <button
                    ...
                    className={`p-3 rounded-xl text-left transition-all border ${
                      size.startsWith(s.label)
                        ? "bg-purple-700 border-purple-800 text-white shadow-sm"
                        : "bg-purple-50/50 border-purple-100 text-zinc-700 hover:border-purple-300 hover:text-purple-900"
                    }`}
                  >
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-purple-50/40 border border-purple-200 rounded-xl p-3.5 text-xs text-zinc-900 placeholder-zinc-400 focus:outline-none focus:border-purple-600 transition-colors"
              />
            </div>

            {/* Submit Button */}
            <div className="pt-2 border-t border-purple-100 flex flex-col sm:flex-row items-center justify-between gap-4">
